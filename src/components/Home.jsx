    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-7 col-12">
          ...
          Highly skilled Python developer . Strong expertise in developing and maintaining 
          complex applications using Python, Django. Proficient in using object-oriented programming 
          concepts and design patterns. Experience working with databases such as PostgreSQL and MongoDB. 
          Strong debugging and problem-solving skills. Proven ability to work well in a team environment
          </p>
          <a
            href="#contact"
